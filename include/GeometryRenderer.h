...
public:
    ...
    // this is called by ADisplay to render a single frame
...
private:
    ...
    QHash<int, int>             objectIdADisplayListIdMap;

    QVector<int> visibleADisplayListIds;
    QVector<int> objectsToBeADisplayedIds;
};
